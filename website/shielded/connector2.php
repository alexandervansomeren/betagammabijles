...
class ConnectorClass
{
    ...
    private function Connect()                 // Connection preparing function.
    {
		...
		$this -> servername = filter_var( $this -> ConnectionIniArray["servername"], FILTER_SANITIZE_STRING );
        ...
        //catch ( Exeption $e ){ echo('Connection to database failed.'); }
       	...
       	try { 
			$databaseConnection = new PDO( "mysql:host=localhost;dbname=webdb13BG2; charset=UTF-8", $this -> username, $this -> password );
       	} 
