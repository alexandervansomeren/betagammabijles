...
<style>
	...
	.content .details .button { width: inherit; margin-top: 10px; display: block; border: 2px solid #FF7F00; background-color: #FF7F00; opacity: 0.85; }
        .content .details .button:hover { opacity: 1; }
